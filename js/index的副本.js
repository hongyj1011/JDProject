define(["jquery", "mockMin", "template", "swiper"], function($, Mock, template, Swiper) {
	(function() {
		...
		initSiteNav: function() {
			$.ajax({
				...
				success: function(data) {
					...
					require(["text!../template/siteNavModel.html"],function (templateHtml) {
						var html =  template.render(templateHtml,jsonArr);
